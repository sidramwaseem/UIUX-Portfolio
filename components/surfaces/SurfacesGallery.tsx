      ...
      <header className="mb-12">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-4 max-w-[40ch] text-[15px] leading-[1.65] text-ink-secondary">
              LinkedIn carousels, infographics, and brand posts — social media design from my time at Enterprise64.
            </p>
            <p className="mt-3 font-mono text-[11px] tracking-wide text-ink-disabled">
          ...
          <button
            ...
            className="mt-1 flex shrink-0 items-center gap-2 rounded-full border border-[#D9D7D2] px-3 py-1.5 font-mono text-[10px] uppercase tracking-[0.1em] text-ink-disabled transition-all duration-150 hover:border-ink hover:text-ink-secondary"
          >
